...
public class EtatAttaque : EtatEnnemi
{
    ...
    public override void Executer(float deltaTime)
    {
        ...
        float distanceCible = (positionCible - positionEnnemi).magnitude;
        ...
        if (distanceCible > sujet.distanceAttaqueToPoursuite + sujet.distancePoursuiteToAttaque)
        {
    ...
    {
        sujet.cibleCourante.PerdreVie(sujet.dommages);
    }
}
